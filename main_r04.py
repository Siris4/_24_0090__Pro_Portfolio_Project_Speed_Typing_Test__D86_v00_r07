...
def calculate_speed():
    ...
    # Unbind the spacebar to prevent it from affecting the result window
...
# function to check the typed word and update the displayed words
def check_word(event):
    ...
    test_text.tag_remove("correct", "1.0", "end")
    test_text.tag_remove("incorrect", "1.0", "end")
    ...
    # Update the word index to highlight the next word correctly
    words_index += len(current_word) + 1  # add space after word
